...
/* IMPLEMENTACION DEL PROGRAMA DEL HOSPITAL CON PRIORITYQUEUE<E> DEL JCF
 * 
 * JUAN LORTHIOIS
 * NIKOLAS BADANI
 * 
...
public class Main {
	...
	public static PriorityQueue<Paciente> cola_pacientes = new PriorityQueue<Paciente>();
	...
	public static void prompt() {
		...
		System.out.println(" ");		
		System.out.println("	-------------------------- HOSPITAL CON PRIORITYQUEUE DEL JCF -----------------------");
		System.out.println(" ");		
